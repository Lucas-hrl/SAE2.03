...
urlpatterns = [
    ...
    path("update_groupe/<int:id>/",views.update_groupe, name = "update_groupe"),
    path("traitement_update_groupe/<int:id>/",views.traitement_update_groupe,),
    path("supprimer_groupe/<int:id>/",views.supprimer_groupe, name = "supprimer_groupe"),
    ...
    path("afficher_etudiant/<int:id>/", views.afficher_etudiant, name = "afficher_etudiant"),
    ...
    path("afficher_enseignant/<int:id>/", views.afficher_enseignant, name = "afficher_enseignant"),
    ...
    path("supprimer_cours/<int:id>/",views.supprimer_cours, name = "supprimer_cours"),
    ...
    path("afficher_absence/<int:id>/", views.afficher_absence, name = "afficher_absence"),
    path("update_absence/<int:id>/",views.update_absence, name = "update_absence"),
